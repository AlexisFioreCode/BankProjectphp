  ...
  <main class="my-5"> 
    <section class="container">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title"><?php echo $_GET['number']?></h5>
              <p class="card-text"><?php echo $_GET['owner']?></p>
              <p class="card-text"><?php echo $_GET['amount']?></p>
              <p class="card-text"><?php echo $_GET['last_operation']?></p>
